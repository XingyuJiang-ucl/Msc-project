...
def inference(data_root = "UCLH_224_L3_HU1",model_name = 'vision transformer',weight_root = r"D:\Msc project\code\checkpoint\UCLH\1 HU\vit\best_finetunemodel_acc_UCLH_HU1.pth"):
    ...
    # Load training data
    table_train,label_train  = load_tabular_data(train_table_root, 'Renal',keys_to_skip)
    ...
    # Load val data
    table_test, label_test = load_tabular_data(test_table_root, 'Renal', keys_to_skip)
