...
def inference(data_root = "2D Slices 224 Tumor",model_name = 'vision transformer',weight_root = r"D:\Msc project\code\checkpoint\kits23\vit\bestacc_kits23model_finetune.pth"):
    """
    training pipeline.
    ...
    test_table_root = data_root / "test" / "merged_table_data_test.json"
    # Load val data
    table_test, _ ,label_test= load_tabular_data(test_table_root, keys_to_skip)
