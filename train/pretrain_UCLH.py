...
def train():
    ...
    data_root = current_dir.parent / "UCLH_224_L3_HU1"
    ...
    cfg = dotdict(
        ...
        arch = 'vision transformer', # 'resnet50d', 'vision transformer'
        d_block = 512,
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if top5_val > best_val_top5:
            ...
            no_improve_count = 0
            save_path = f"best_UCLHmodel_acc_1HU.pth"
        ...
        #         break
        save_path = f"latest_UCLHmodel_1HU.pth"
        torch.save(model.state_dict(), save_path)
    ...
    df_metrics.to_csv("pretrain_UCLH.csv", index=False)
